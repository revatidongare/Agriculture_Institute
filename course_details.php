...
<!--   <div id="home"> -->
  ...
  <!-- <section class="service py-lg-4 py-md-4 py-sm-3 py-3" id="service" >
    <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
      <h3 class="title text-center mb-2" style="padding-top: 2rem;">Diploma Course Details</h3>
...
<!-- blog -->
  ...
  <section class="blog py-lg-5 py-md-4 py-sm-3 py-3" id="blog">
    <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
      <h3 class="title text-center mb-2">Course Details</h3>
      
      <div class="row">
        <div class="blog-wthree-color col-lg-4 position-relative my-3">
          <div class="w3ls-post-img">
            <img src="images/seed-planting.jpg" class="img-fluid" alt="">
        ...
        <div class="blog-wthree-color col-lg-4 position-relative my-3">
          <div class="w3ls-post-img">
            <img src="images/soiltest.jpg" class="img-fluid" alt="">
            <!-- <div class="blog-info">
              <a href="#about">
                <ul>
                  <li>JUL</li>
          ...
          <div class="blog-txt-info">
            <h4 class="mb-2">
              <a href="#about">Soil Testing </a>
            </h4>
            <p>A soil test is important for several reasons: to optimize crop production, to protect the environment from contamination by runoff and leaching of excess fertilizers, to aid in the diagnosis of plant culture problems, to improve the nutritional balance of the growing media and to save money and conserve energy by applying only the amount of fertilizer needed.</p>
            <div class="news-date-list pt-2">
              <!-- <ul>
                <li class="mr-1">
                  <a href="#">12/4/2019</a>
